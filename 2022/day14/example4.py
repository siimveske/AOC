#https://github.com/shepherdjay/advent_of_code/blob/main/2022/14/day14.py
...
if __name__ == '__main__':
    with open('input.txt', 'r') as rock_file:
        rock_positions = set().union(*[expand_coordinates(line) for line in rock_file])
        rock_positions2 = rock_positions.copy()

    print(cave_in(rock_positions))
    print(cave_in(rock_positions2, floor=True))

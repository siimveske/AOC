...
def main():
    ...
    # We expect n! perms
    happiness_for_perm, optimum_happiness_perm = find_optimum_happiness(
        happiness_by_person, person_1, people
    )
    print(
        f"Optimum happiness = {happiness_for_perm[optimum_happiness_perm]} with seating: {optimum_happiness_perm}"
    )
...
def find_optimum_happiness(happiness_by_person, person_1, people):
    ...
    for perm in perms:
        ...
        if perm <= perm[::-1]:
            ...
            happiness_for_perm[tuple(perm)] = compute_happiness_for_perm(
                perm, happiness_by_person
            )
